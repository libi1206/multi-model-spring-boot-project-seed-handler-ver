...
public class SysApiCfgServiceImpl extends ServiceImpl<SysApiCfgDao, SysApiCfg> implements SysApiCfgService {

    @Override
    public SysApiCfg getSysApiCfg(String kindId, String apiVersion) {
        QueryWrapper<SysApiCfg> wrapper = new QueryWrapper<>();
    ...
    @Override
    public List<SysApiCfg> getApiList() {
        QueryWrapper<SysApiCfg> queryWrapper=new QueryWrapper<>();
